...
<template v-slot:center>
  ...
  <Textarea v-model=chat.first_instruction description="1st_instruction" width="500px"></Textarea>
  <InputNumber v-model="chat.ctx_size" description="Ctx size" min=1 max=4096 step=1 :continuous_update=False width="500px"></InputNumber>
  <FloatSlider v-model="chat.temp" description="Temperature" min=0 max=1 step=0.01 :continuous_update=False width="500px"></FloatSlider>
  <InputNumber v-model="chat.top_k" description="TopK" min=1 max=10000 step=1 :continuous_update=False width="500px"></InputNumber>
  <FloatSlider v-model="chat.top_p" description="TopP" min=0 max=1 step=0.01 :continuous_update=False width="500px"></FloatSlider>
  <FloatSlider v-model="chat.repeat_penalty" description="Repeat penalty" min=1 max=2 step=0.1 :continuous_update=False width="500px"></FloatSlider>
